...
--
-- This migration is additive and idempotent. It only writes a new snapshot when
-- the persisted ranking actually changes, avoiding history noise from repeated
-- runtime bootstraps with identical scores.
