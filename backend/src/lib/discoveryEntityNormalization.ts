...
const leadingDescriptorBrand = /^(?:fintech|startup|empresa|plataforma|healthtech|agtech|insurtech|proptech|edtech)\s+(?!de\b|do\b|da\b|dos\b|das\b)([A-Za-zÀ-ÿ0-9][A-Za-zÀ-ÿ0-9 .&+_-]{1,44})$/i;
