...
O conector é saudável quando ao menos uma página pública é lida, validada contra o CNPJ solicitado e persistida. Erros da Edge Function exibidos pela página são registrados como aviso; o snapshot só é aceito quando o conteúdo público ainda contém evidências suficientes.
